...
namespace WordPressMigrationTool
{
    public class MigrationService
    {
        ...
        public Result Migrate()
        {
            try
            {
                this._migrationUxForm.OnMigrationCompletion(false);
        ...
        // Initates migration, logs status in Kudu table and returns if migration is successful
        public bool MigrateAsyncForWinUI()
        {
            try
            {
